...
#     end
# end
# # Re-dispatch_ots_oltc_pst_droop
# result_re_dispatch =  PM_acdc_sc.run_acdcreopf_ots_oltc_pst(data, PM.ACPPowerModel, minlp_solver)
...
data1 = deepcopy(data)
result_ACDC_scopf_re_dispatch_oltc_pst =  PM_acdc_sc.run_acdcreopf_oltc_pst(data, PM.ACPPowerModel, nlp_solver)
# Re-dispatch_ots_oltc_pst
result_ACDC_scopf_re_dispatch_ots_oltc_pst =  PM_acdc_sc.run_acdcreopf_ots_oltc_pst(data1, PM.ACPPowerModel, minlp_solver)
