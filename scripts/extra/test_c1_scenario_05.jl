...
c1_scenarios = "scenario_05"  #, "scenario_02"]
...
for i=1:length(data["load"])
    data["load"]["$i"]["pd"] = data["load"]["$i"]["pd"] * 0.5
    data["load"]["$i"]["qd"] = data["load"]["$i"]["qd"] * 0.5
end
