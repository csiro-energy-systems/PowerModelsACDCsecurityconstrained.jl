...
network["branch_contingencies"][7]=(idx = 7, label = "LINE-4-5-BL", type = "branch")
network["branch_contingencies"][9]=(idx = 9, label = "LINE-6-12-BL", type = "branch")
network["branch_contingencies"][10]=(idx = 10, label = "LINE-6-13-BL", type = "branch")
network["branch_contingencies"][6]=(idx = 6, label = "LINE-3-4-BL", type = "branch")
#network["branch_contingencies"][5]=(idx = 1, label = "LINE-1-2-BL", type = "branch")
network["branch_contingencies"][2]=(idx = 2, label = "LINE-1-5-BL", type = "branch")
network["branch_contingencies"][3]=(idx = 3, label = "LINE-2-3-BL", type = "branch")
network["branch_contingencies"][4]=(idx = 4, label = "LINE-2-4-BL", type = "branch")
network["branch_contingencies"][5]=(idx = 5, label = "LINE-2-5-BL", type = "branch")
network["branch_contingencies"][8]=(idx = 8, label = "LINE-6-11-BL", type = "branch")
network["branch_contingencies"][11]=(idx = 11, label = "LINE-7-8-BL", type = "branch")
...
#scopf_dc_cuts_soft_woc_objective = [14642.16, 26982.17]
    ...
    result = PowerModelsSecurityConstrained.run_c1_scopf_cuts_soft(network, DCPPowerModel, lp_solver)  #_GM
