...
function run_acdcopf(file::String, model_type::Type, solver; kwargs...)
    ...
    return run_acdcopf_cp(data, model_type, solver; ref_extensions=[_PMACDC.add_ref_dcgrid!], kwargs...)
end

""
function run_acdcopf(data::Dict{String,Any}, model_type::Type, solver; kwargs...)
    solution_processors = [solution_processor]
    return _PM.solve_model(data, model_type, solver, build_acdcopf; ref_extensions=[_PMACDC.add_ref_dcgrid!], solution_processors, kwargs...)
end
