...
# while true
    ...
    t_conts_ndc = @elapsed conts_ndc =  filter_dominated_contingencies(gen_cuts, branch_cuts, branchdc_cuts, convdc_cuts, active_conts_by_branch, active_conts_by_branchdc)
    ...
    t_scopf = @elapsed @time result_scopf = _PMSCACDC.run_scopf_acdc_cuts_remote(network, _PM.ACPPowerModel, _PM.ACPPowerModel, _PMSCACDC.run_acdc_scopf_cuts_soft, nlp_solver, nlp_solver, setting)
